...
"""Inference-only Stage-2 recipe for the fixed-base RoboCasa Atomic-5 policy.

The recipe deliberately derives from the public DROID Nano recipe.  RoboCasa
dataset construction is not needed while serving and would make this overlay
depend on unpublished training-only configuration modules.
"""
